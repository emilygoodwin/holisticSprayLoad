  ...
  class HtmlAudioResponsePlugin {
      ...
      showDisplay(display_element, trial) {
          ...
          if (trial.show_done_button) {
              html += `<p><button class="end-recording-button" id="finish-trial">${trial.done_button_label}</button></p>`;
          }
      ...
      <button id="record-again" class="start-recording-btn">${trial.record_again_button_label}</button>
      <button id="continue" class="end-recording-button">${trial.accept_button_label}</button>
    `;
